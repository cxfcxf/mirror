package com.cxfcxf.mirror.service
...
import com.cxfcxf.mirror.MainActivity
import com.cxfcxf.mirror.Prefs
import com.cxfcxf.mirror.R
import com.cxfcxf.mirror.audio.DacpController
import com.cxfcxf.mirror.audio.DmapParser
import com.cxfcxf.mirror.audio.TrackInfo
import com.cxfcxf.mirror.bridge.NativeBridge
import com.cxfcxf.mirror.bridge.RaopCallbackHandler
import com.cxfcxf.mirror.discovery.NsdServiceManager
import com.cxfcxf.mirror.renderer.AudioRenderer
import com.cxfcxf.mirror.renderer.VideoRenderer
import com.cxfcxf.mirror.viewmodel.DebugInfo
...
class AirPlayService : Service(), RaopCallbackHandler {
    ...
    companion object {
        ...
        const val ACTION_PLAY_PAUSE = "com.cxfcxf.mirror.PLAY_PAUSE"
        const val ACTION_NEXT = "com.cxfcxf.mirror.NEXT"
        const val ACTION_PREV = "com.cxfcxf.mirror.PREV"
        const val ACTION_START_SERVER = "com.cxfcxf.mirror.START_SERVER"
    }
}
